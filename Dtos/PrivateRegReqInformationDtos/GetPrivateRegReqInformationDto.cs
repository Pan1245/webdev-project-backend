...
namespace houseofgriffin_api.Dtos.PrivateRegReqInformationDtos
{
    public class GetPrivateRegReqInformationDto
    {
        ...
        public List<GetPreferredDayDto> preferredDays { get; set; } = new List<GetPreferredDayDto>();
    }
}